//! E2E test for the cross-language-math template.
//!
...
//!
//! Run with:
//!   cargo test --test e2e_cross_language_math -- --ignored --nocapture
//!
//! Requires:
...
#[tokio::test]
#[ignore]
async fn cross_language_math() {
    let mut scenario = e2e_harness::Scenario::builder("cross-language-math", "iii")
        .build()
        .await;
